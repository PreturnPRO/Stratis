...
export const INITIAL_NODES = [
  ...
  },
  {
    ...
    w: 220,
    h: 90,
    label: "Restructure pricing tier...",
    age: "14d",
    borderColor: "#e8a020",
    glow: true,
  },
  {
    ...
    w: 200,
    h: 90,
    label: "Seat-based + overages",
    age: "14d",
    borderColor: "#1a8c6e",
    tag: { label: "Safe", color: "#e8520a" },
  },
  {
    id: "usage",
    x: 660,
    ...
    w: 200,
    h: 95,
    label: "Pure usage-based",
    age: "14d",
    borderColor: "#1a8c6e",
    tags: [
      { label: "AI recommended", color: "#1a8c6e" },
      { label: "Validated", color: "#444444" },
    ],
  },
  {
    id: "value",
    ...
    age: "14d",
    borderColor: "#1a8c6e",
    tag: { label: "High effort", color: "#e8520a" },
  },
  {
    id: "smb",
    x: 930,
    ...
    w: 200,
    h: 85,
    label: "SMB accepts metered bill...",
    age: "94d",
    borderColor: "#e8a020",
  },
  {
    ...
    w: 200,
    h: 75,
    label: "Engineering ships in 6 w...",
    age: "8d",
    borderColor: "#c0392b",
  },
  {
    ...
    w: 200,
    h: 75,
    label: "Engineering capacity con...",
    age: "8d",
    borderColor: "#c0392b",
  },
];
...
<<<<<<< Updated upstream
  ...
  { user: "Sarah K.", initials: "SK", color: "#c0392b", time: "01:48", text: "Exactly. So the core decision is: how do we restructure pricing? I've mapped three options on the canvas." },
  { user: "Mike R.",  initials: "MR", color: "#2e86c1", time: "02:05", text: "Option A — seat-based with overages — feels safest. It's closest to what we have now and engineering can implement it faster." },
...
<<<<<<< Updated upstream
  ...
  { icon: "N",  iconBg: "#1a3a2a", title: "Notion: Product strategy doc — pricing options", desc: "Document outlines 3 pricing options with pros/cons analysis.",                                     tag: "doc",        date: "2026-07-22", unread: false },
